...
st.write(result)
if result==[[2]]:
	img = Image.open("Iris_virginica.jpeg")
	st.image(img,caption="Iris_virginica",width=600) 

if result==[[1]]:
	img = Image.open("Iris-versicolor.jpeg")
	st.image(img,caption="Iris-versicolor",width=600) 

if result==[[0]]:
	img = Image.open("Iris-setosa.jpeg")
	st.image(img,caption="Iris-setosa",width=600) 
